      ...
      <div className="border-2 border-black p-4 rounded-md mt-4 bg-white">
        ...
        <div className="mt-4 flex items-center">
          <button
            ...
            className={`w-full text-white py-2 px-4 rounded-md border-2 border-black hover:bg-green-600 ${
              questions.length === 0 ? "bg-gray-400" : "bg-green-500"
            }`}
          ...
          <button
            onClick={exportToCsv}
            className={`w-full text-white py-2 px-4 rounded-md border-2 border-black hover:bg-yellow-600 ml-4 ${
              questions.length === 0 ? "bg-gray-400" : "bg-yellow-500"
            }`}
            disabled={questions.length === 0}
          >
            Export as CSV
